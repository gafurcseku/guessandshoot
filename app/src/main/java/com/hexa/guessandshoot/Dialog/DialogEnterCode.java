...
public class DialogEnterCode extends Dialog implements View.OnClickListener {
  ...
  public DialogEnterCode(Activity a) {
    super(a);
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    TV_Note.setText(Html.fromHtml(Settings.getSettings().getNote_02()));
  ...
  public void sendRequest(){
    ...
    if (ED_name.getText().toString().isEmpty()){
      Settings.alertDialog(c,c.getResources().getString(R.string.enterCode));
      return;
    }
    RequestParams requestParams = new RequestParams() ;
    try {
      requestParams.put("code",ED_name.getText().toString());
