...
public class Adapter_list_number_1 extends RecyclerView.Adapter<Adapter_list_number_1.ViewHolder> {
  ...
  public static   String select_nubmer = "";
    ...
    public Adapter_list_number_1(ArrayList<String> list, Context context) {
        this.list = list;
